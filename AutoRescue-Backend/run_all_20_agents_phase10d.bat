@echo off
REM AutoRescue AI - Phase 10D: Run All 20 Agents (Fixed)
REM Uses uv run with proper PYTHONPATH for all services

setlocal enabledelayedexpansion

echo.
echo ====================================================================
echo   AutoRescue AI - PHASE 10D: 20-Agent System
echo ====================================================================
echo.
...
echo [INFO] Using: uv run python with PYTHONPATH=.
echo.
...
echo ====================================================================
echo.
echo [SUCCESS] All 21 services started
echo.
echo NEXT STEPS:
echo 1. Wait 10-15 seconds for agents to initialize
echo 2. Run: check_services.bat
echo 3. Run tests: uv run python test_20_agents.py
echo.
echo ====================================================================
echo.
